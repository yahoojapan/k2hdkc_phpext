 ...
 * Stub hash: bb431b584b920bdd429ea0980c7d1a1d39e0ba09 */

ZEND_BEGIN_ARG_INFO_EX(arginfo_k2hdkcpx_open, -2, 0, 1)
	ZEND_ARG_TYPE_INFO(0, configFile, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, port, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, cuk, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, rejoin, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, rejoinForever, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, clearBackup, _IS_BOOL, 0)
	ZEND_END_ARG_INFO();

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_set_value, -1, 3, _IS_BOOL, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_TYPE_INFO(0, key, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, val, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, clearSubkeys, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, subkeys, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	// cppcheck-suppress unknownMacro
	ZEND_ARG_TYPE_INFO(0, expirationDuration, IS_LONG, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_add_subkey, 0, 4, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, check_attr, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, expiration_duration, IS_LONG, 0)
	ZEND_END_ARG_INFO();

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_cas_get, 0, 2, IS_LONG, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_TYPE_INFO(0, key, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_close, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_INFO(0, handle_res)
	ZEND_ARG_TYPE_INFO(0, is_clean_bup, _IS_BOOL, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_queue_get, 0, 2, IS_STRING, 1)
	...
	ZEND_ARG_TYPE_INFO(0, is_fifo, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_queue_put, 0, 3, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, val, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_fifo, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, is_check_attr, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, expiration_duration, IS_LONG, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_remove_subkeys, 0, 3, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, key, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, subkeys, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, nested, _IS_BOOL, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_k2hdkcpx_rename, 0, 3, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, parent_key, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_check_attr, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, expiration_duration, IS_LONG, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_K2hdkc___construct, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, config_file, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, port, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, cuk, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, rejoin, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, rejoin_forever, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, clear_backup, _IS_BOOL, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_K2hdkc_setValue, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, key, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, val, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, clear_subkeys, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, subkeys, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, expiration_duration, IS_LONG, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_K2hdkc_casGet, 0, 1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, key, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_K2hdkc_keyQueueGet, 0, 1, IS_ARRAY, 1)
	ZEND_ARG_TYPE_INFO(0, prefix, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, is_fifo, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, password, IS_STRING, 0)
	ZEND_END_ARG_INFO();
...
static void register_k2hdkcpx_symbols(int module_number)
{
	REGISTER_LONG_CONSTANT("K2HDKC_INVALID_HANDLE", K2HDKC_INVALID_HANDLE, CONST_PERSISTENT);
}
...
static zend_class_entry *register_class_K2hdkc(void)
{
	...
	zend_register_class_alias("K2hdkcPx", class_entry);
	...
	zend_declare_typed_property(class_entry, property__config_file_name, &property__config_file_default_value, ZEND_ACC_PRIVATE, NULL, ZEND_TYPE_ENCODE(IS_STRING, ""));
	...
	zend_declare_typed_property(class_entry, property__port_name, &property__port_default_value, ZEND_ACC_PRIVATE, NULL, ZEND_TYPE_ENCODE(IS_LONG, 0));
	...
	zend_declare_typed_property(class_entry, property__cuk_name, &property__cuk_default_value, ZEND_ACC_PRIVATE, NULL, ZEND_TYPE_ENCODE(IS_STRING, ""));
	...
	zend_declare_typed_property(class_entry, property__rejoin_name, &property__rejoin_default_value, ZEND_ACC_PRIVATE, NULL, ZEND_TYPE_ENCODE(IS_LONG, 1));
	...
	zend_declare_typed_property(class_entry, property__rejoin_forever_name, &property__rejoin_forever_default_value, ZEND_ACC_PRIVATE, NULL, ZEND_TYPE_ENCODE(IS_LONG, 1));
	...
	zend_declare_typed_property(class_entry, property__clear_backup_name, &property__clear_backup_default_value, ZEND_ACC_PRIVATE, NULL, ZEND_TYPE_ENCODE(IS_LONG, 1));
